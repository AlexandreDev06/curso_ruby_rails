  ...
  task add_coins: :environment do
    show_spinner("Cadastrando Moedas...") do
      coins = [
        { description: "Bitcoin",
          acronym: "BTC",
          url_image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSixU_vNiGd5rmhMPjwDixDfDUb2zj09Gm2qg&usqp=CAU",
        ...
        { description: "Dash",
          acronym: "DASH",
          url_image: "https://s3.cointelegraph.com/storage/uploads/view/6c9ae354d0ca897e55598ee6a8bf3e10.png",
          mining_type: MiningType.all.sample },
      ]
